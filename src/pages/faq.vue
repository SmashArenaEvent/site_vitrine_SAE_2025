...
<template>
    ...
    <nav class="lg:col-start-2 col-span-12 lg:col-span-10 flex flex-wrap justify-center lg:justify-between gap-5">
        ...
        <a href="#tournoi">
            <button class="bg-Blanc h-12 lg:h-20 -skew-x-[25deg]">
                <p class="text-Noir font-fugaz-one uppercase text-xs lg:text-xl px-6 lg:px-9 skew-x-[25deg]">Le tournoi</p>
            </button>
        </a>
        <a href="#accessible">
            <button class="bg-Blanc h-12 lg:h-20 -skew-x-[25deg]">
                <p class="text-Noir font-fugaz-one uppercase text-xs lg:text-xl px-6 lg:px-9 skew-x-[25deg]">L'accessibilité</p>
            </button>
        </a>
        <a href="#benevole">
            <button class="bg-Blanc h-12 lg:h-20 -skew-x-[25deg]">
                <p class="text-Noir font-fugaz-one uppercase text-xs lg:text-xl px-6 lg:px-9 skew-x-[25deg]">Le bénévolat</p>
            </button>
        </a>
    </nav>
