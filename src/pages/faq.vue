...
<template>
    ...
    <article id="event">
        <h2 class="font-fugaz-one uppercase text-3xl"><span class="text-Tonic">L'</span>évenement</h2>
        ...
        <CardFAQ Style="0" Title="Peut-on annuler notre  participation à l’événement que ce soit en tant  que joueur et bénévole ?" Text="Oui, en prévenant les organisateurs une semaine à l’avance via nos réseaux sociaux ou notre formulaire de contact. Sans cela, vous resterez inscrit et vos données seront conservées un an." />
        <CardFAQ Style="0" Title="Quelles sont les mesures de sécurité mises en place ?" Text="Pour votre sécurité, nous effectuerons des fouilles pour éviter tout objet dangereux dans l’enceinte de notre événement. Il y aura également une vérification du matériel informatique pour éviter tout incendie. Un garde sera aussi présent pour éviter tout débordement." />
    ...
    <article id="tournoi">
        <h2 class="font-fugaz-one uppercase text-3xl"><span class="text-Tonic">Le</span> tournois</h2>
        ...
        <CardFAQ Style="1" Title="Sur quelle plate-forme du jeu se déroule le tournoi ?" Text="Le jeu se déroulera sur plusieurs Nintendo Switch." />
        <CardFAQ Style="1" Title="Dois-je emmener  ma propre manette ?" Text="Oui, il est même OBLIGATOIRE d’amener votre propre manette. Quelques joycons seront mis à disposition s'il y a un oubli, prenez en compte qu’il y a un stock limité." />
        <CardFAQ Style="1" Title="Le tournoi sera-t-il diffusé en streaming ?" Text="Oui la seconde édition du tournois sera certainement diffusé en streaming" />
        <CardFAQ Style="1" Title="Y aura-t-il des commentaires pour les matchs lors du tournoi ?" Text="Pour dynamiser et mettre l’ambiance, il y aura des bénévoles réquisitionnés pour faire les commentateurs à chaque poste de Switch lié au tournoi." />
    ...
    <article id="accessible">
        <h2 class="font-fugaz-one uppercase text-3xl"><span class="text-Tonic">L'</span>accessibilité</h2>
    ...
    <article id="benevole">
        <h2 class="font-fugaz-one uppercase text-3xl"><span class="text-Tonic">Le</span> bénévolat</h2>
        ...
        <CardFAQ Style="1" Title="Y a-t-il des compétences spécifiques que vous recherchez chez les bénévoles ?" Text="Oui, vous pourrez voir cela en téléchargeant les fiches décrivant les postes au sein de l’événement." />
        <CardFAQ Style="1" Title="Proposez-vous une formation pour les bénévoles ?" Text="Nous ne proposons pas de formations pour les bénévoles, en revanche, nous organiserons une rencontre au préalable avec l’ensemble pour discuter du déroulement de l’événement." />
        <CardFAQ Style="1" Title="Est-ce que le bénévolat  est occasionnel ou régulier ?" Text="Il est occasionnel, car il ne durera qu’une après-midi cette année, il y aura également un système de roulette pour avoir des pauses et également partir de l’événement si vous avez une autre occupation à faire dans la journée." />
        <CardFAQ Style="1" Title="Quelle est la politique en cas d'annulation ou de modification de mes disponibilités ?" Text="Non, il n’est pas possible d’amener votre propre nourriture à l’événement. En revanche, une restauration et une buvette sera mise en place pour vos besoins." />
        <CardFAQ Style="1" Title="Dois-je informer l'organisation à l'avance en cas de changement de mes engagements ?" Text="Oui, vous devez nous tenir au courant de toute modification et changement lié à vos engagements. Si cela n’est pas fait, cela peut mettre en péril le bon déroulement de l’événement." />
        <CardFAQ Style="1" Title="Y a-t-il une limite d'âge pour les bénévoles ?" Text="Conformément à la loi n° 2006-586 du 23 mai 2006 relative au volontariat associatif et à l'engagement éducatif - Article 3, la personne volontaire doit être âgée de plus de seize ans. Pour les personnes âgées de plus de seize ans et de moins de dix-huit ans, une autorisation parentale est exigée. Une visite médicale préalable est obligatoire. Les modalités d'accueil du mineur sont fixées par décret." />
