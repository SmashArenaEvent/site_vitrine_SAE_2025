...
<template>
  ...
  <section class="col-span-12 col12">
    ...
    <nav class="col-span-12 flex flex-col lg:flex-row overflow-hidden mt-6 lg:mt-12">
      <div class="hover:z-10 relative w-full bg-center bg-cover bg-[url('/src/components/img/WallPaperJoueur.png')] overflow-hidden hover:scale-110 transition-all duration-1000">
        <div class="h-52 lg:h-[608px] w-full bg-Noir_Vert hover:bg-transparent transition-all duration-1000 overflow-hidden">
          <div class="h-full w-full col12 content-center hover:scale-[0.91] transition-all duration-1000">
      ...
      <div class="hover:z-10 relative w-full bg-center bg-cover bg-[url('/src/components/img/WallPaperBenevole.png')] overflow-hidden hover:scale-110 transition-all duration-1000">
        <div class="lg:z-10 h-52 lg:h-[608px] w-full bg-Noir_Vert hover:bg-transparent transition-all duration-1000 overflow-hidden">
