...
<template>
  <h1 class="col-span-12 font-fugaz-one uppercase text-4xl lg:text-6xl mt-8 lg:pb-12">
    <span class="text-Tonic">P</span>olitique <span class="text-Tonic">d</span>e
    <span class="text-Tonic">c</span>onfidentialité
  </h1>
  <section class="col-span-12">
    <h2
      class="font-fugaz-one uppercase text-3xl lg:text-5xl mb-6 lg:mb-12 mt-16 lg:mt-0 lg:!leading-[3.5rem]"
    >
  ...
  <section class="col-span-12">
    <h2
      class="font-fugaz-one uppercase text-3xl lg:text-5xl mt-12 mb-6 lg:mt-24 lg:mb-12 lg:!leading-[3.5rem]"
    >
    ...
    <p class="lg:text-xl leading-6 lg:leading-10">
      ...
      soient utilisées dans le cadre du tournoi. Les données ne seront pas partagées, vendues ou
      louées à des tiers.
    </p>
  </section>
  <section class="col-span-12">
  ...
  <section class="col-span-12">
    ...
    <p class="lg:text-xl leading-6 lg:leading-10">
      ...
      réaliser un changement ou une suppression de leurs données personnelles.
    </p>
  </section>
  <section class="col-span-12">
    <h2
