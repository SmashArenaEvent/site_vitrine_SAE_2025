<template>
    <div id="cookies-element" class="top-0 w-full h-screen fixed z-50 bg-[rgba(0,0,0,0.5)] border border-Blanc hidden">
            ...
            <section id="cookie-banner" class="py-5 px-10 bg-Noir border-2 border-Tonic text-Blanc absolute w-full max-w-[800px] bottom-0 text-sm lg:text-base">
                ...
                <div class="flex mt-4 gap-5">
                    <button @click="acceptCookies(true)" class="bg-Tonic h-8 -skew-x-[25deg] hover:opacity-60 duration-200">
                        <p
                        class="text-Noir font-fugaz-one uppercase lg:text-xs text-[0.8rem] px-3 skew-x-[25deg]"
                        >
                        Tout accepter
                        </p>
                    </button>
                    ...
                    <button  @click="acceptCookies(false)" class="h-8 -skew-x-[25deg] hover:opacity-60 duration-200">
                        <p
                        class="text-Blanc opacity-90 font-fugaz-one uppercase lg:text-xs text-[0.8rem] px-3 skew-x-[25deg]"
                        >
                        Tout refuser
                        </p>
                    </button>
